# CONTACT
SAMARTHRAWAT18@GMAIL.COM FOR USING THE PROJECT AS SPOTIFY HAS RATE LIMITS ON DEVELOPMENT MODE APIS, EACH USAGE NEED EMAIL-ID TO BE ADDED BY THE API ADMINISTRATOR FROM THE SPOTIFY DASHBOARD.
